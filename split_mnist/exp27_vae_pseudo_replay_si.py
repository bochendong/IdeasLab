# ===== Exp27: Exp9 VAE 伪样本 + SI =====
"""VAE 伪样本 CE 回放（同 Exp9）+ Synaptic Intelligence 参数正则。"""
import os
import sys
import copy
import logging
...
def run_experiment_vae_si(
    run_name: str = "exp27_vae_pseudo_replay_si",
    config: dict = None,
...
if __name__ == "__main__":
    run_experiment_vae_si(
        run_name="exp27_vae_pseudo_replay_si",
