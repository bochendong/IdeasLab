# ===== Exp35: 双判别器 + Slice margin =====
"""Exp32 + 对伪旧样本显式约束 correct_slice_max - best_other_max >= margin。"""
import os
import sys
import copy
import logging
...
def run_experiment(run_name="exp35_dual_discriminator_slice_margin", config=None, save_model_checkpoint=False, script_file=None,
    vae_epochs=5, vae_n_fake_per_task=32, lambda_adv_feat=0.1, lambda_adv_slice=0.1, slice_margin=0.3, lambda_margin=0.5):
...
if __name__ == "__main__":
    run_experiment(run_name="exp35_dual_discriminator_slice_margin", config={"lambda_slice": 2.0, "lambda_feat": 0.5},
