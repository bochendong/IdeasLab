# ===== Exp25: Slice 高斯化 + Anti-Collapse + SI 组合 =====
"""Exp22 的 Slice 高斯化 + Anti-Collapse 与 Exp19 的 SI 组合，轻量无回放方案。"""
import os
import sys
import copy
import logging
...
def run_experiment_slice_gauss_anticollapse_si(
    run_name: str = "exp25_slice_gauss_anticollapse_si",
    config: dict = None,
...
if __name__ == "__main__":
    run_experiment_slice_gauss_anticollapse_si(
        run_name="exp25_slice_gauss_anticollapse_si",
