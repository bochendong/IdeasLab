# ===== Exp23: 对抗式遗忘抵抗 (Adversarial Anti-Forgetting) =====
"""判别器区分旧/新类特征；backbone 混淆判别器，使旧类表征在新空间仍可区分。"""
import os
import sys
import copy
import logging
...
def run_experiment_adversarial_antiforget(
    run_name: str = "exp23_adversarial_antiforget",
    config: dict = None,
...
if __name__ == "__main__":
    run_experiment_adversarial_antiforget(
        run_name="exp23_adversarial_antiforget",
